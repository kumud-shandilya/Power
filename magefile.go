...
const (
	mixinName    = "power"
	mixinPackage = "github.com/getporter/power"
...
func Publish() {
	...
	if _, overridden := os.LookupEnv(releases.ReleaseRepository); !overridden {
		os.Setenv(releases.ReleaseRepository, "github.com/Kumud Shandilya/YOURREPO")
	}
	...
	//	os.Setenv("PORTER_PACKAGES_REMOTE", "git@github.com:Kumud Shandilya/YOUR_PACKAGES_REPOSITORY")
	//}
